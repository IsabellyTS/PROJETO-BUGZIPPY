...
public class Nivel05 {
    ...
    public void ChamaNivel5(String nome) {
        ...
        String p6 = ">>O que esse código faz?\nwhile (i < 3) { System.out.println(\"Oi\"); i++; }\n" +
                "1) Escreve \"Oi\" mil vezes\n" +
                "2) Escreve \"Oi\" três vezes\n" +
                "3) Não escreve nada\n" +
                "4) Mostra um erro\n";

        String p7 = ">>Qual dessas é uma forma certa de usar do while?\n" +
                "1) while { jogar(); }\n" +
                "2) faça { jogar(); } até parar;\n" +
                "3) do { System.out.println(\"Vamos jogar!\"); } while (jogar == true);\n" +
                "4) repetir { jogar(); } se quiser\n";

        String p8 = ">>O que acontece se a condição do while for falsa logo no começo?\n" +
                "1) Fica preso em um loop\n" +
                "2) Roda uma vez só\n" +
                "3) Mostra \"erro!\"\n" +
                "4) O código não roda\n";

        String p9 = ">>O que o do while faz se a condição for falsa no final?\n" +
                "1) Roda uma vez e para\n" +
                "2) Não roda nada\n" +
                "3) Roda mil vezes\n" +
                "4) Muda o valor sozinho\n";

        String p10 = ">>O que é importante lembrar sobre while e do while?\n" +
